      ...
      bot.telegram.sendMessage(ctx.chat.id, gcamMessage,
        {
            reply_markup: {
              inline_keyboard: [
                ...
                [
                 { text: "Lg g8s βασική και selfie", url: 'https://t.me/hellasmobiles/123598' }
                ],     
                [
